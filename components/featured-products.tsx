    ...
    content: (
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 w-full h-full">
        <img
          ...
          className="rounded-lg w-full h-48 md:h-60 object-cover mt-0 !m-0 shadow-lg border border-slate-200"
        />
        <div className="flex flex-col gap-y-3 md:gap-y-4">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 md:w-12 md:h-12 bg-gradient-to-r from-sky-400 to-blue-600 rounded-xl flex items-center justify-center shadow-lg">
          ...
          <p className="text-xs md:text-sm text-white/90 mt-0 leading-relaxed">
      ...
      <div className="container-custom">
        <Reveal>
          <div className="text-center mb-16">
            <h2 className="text-4xl text-slate-900 mb-4 lg:text-6xl font-bold break-words">
              Why Hotels Choose <span className="font-bold bg-gradient-to-r from-sky-400 to-blue-600 bg-clip-text text-transparent">Aiyra</span>
            </h2>
