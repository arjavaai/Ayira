...
export function NewsletterSection() {
  ...
  return (
    <section className="relative py-32 overflow-hidden bg-gradient-to-b from-neutral-medium/20 to-neutral-light" id="cta">
      ...
      <div className="relative z-10 container-custom">
        <Reveal>
          <div className="max-w-3xl mx-auto text-center px-4 sm:px-0">
            <h2 className="text-3xl sm:text-4xl lg:text-6xl font-bold text-white mb-4 sm:mb-6 break-words">
              Ready to Transform <span className="italic font-bold bg-gradient-to-r from-brand-secondary to-brand-primary bg-clip-text text-transparent">Your Business?</span>
            </h2>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 mb-6 sm:mb-8">
              <motion.a
                href="#experience"
                className="w-full sm:w-auto px-6 sm:px-8 py-3 sm:py-4 bg-gradient-to-r from-brand-secondary to-brand-primary text-white rounded-full font-medium hover:from-brand-primary hover:to-brand-secondary transition-all duration-300 text-base sm:text-lg text-center shadow-lg"
