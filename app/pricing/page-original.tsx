  ...
  return (
    <main className="min-h-screen">
      ...
      <section className="py-20 bg-white">
        <div className="container-custom">
          <ScrollAnimatedWords
            text="Investment Plans That Deliver Results"
            as="h2"
            className="text-4xl lg:text-5xl font-bold mb-12 text-center text-gray-900"
            staggerDelay={0.05}
          />
          <ScrollAnimatedText delay={0.3}>
            <p className="text-xl text-gray-600 text-center mb-16 max-w-3xl mx-auto">
              Choose the plan that matches your hotel's growth stage and business objectives. Every plan includes our complete platform with measurable ROI.
            </p>
          </ScrollAnimatedText>
          <ScrollFadeIn scale>
